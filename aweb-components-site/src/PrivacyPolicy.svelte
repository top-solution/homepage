<svelte:options tag="ts-privacy-policy" />
...
<ts-layout class="privacy-policy">
  <div class="privacy-policy__container">
    ...
    <p><b>Indirizzo email del Titolare</b>: info@topsolution.it</p>
    <hr />
    <div class="title-6"><b>Tipologie di Dati raccolti </b></div>
    <p>
      Fra i Dati Personali raccolti da questa Applicazione, in modo autonomo o
      tramite terze parti, ci sono: nome; numero di telefono; nome; cognome;
      data di nascita; email; varie tipologie di Dati
    </p>
    <p>
      Dettagli completi su ciascuna tipologia di dati raccolti sono forniti
      nelle sezioni dedicate di questa privacy policy o mediante specifici testi
      ...
      questa Applicazione sono obbligatori. Se l’Utente rifiuta di comunicarli,
      potrebbe essere impossibile per questa Applicazione fornire il Servizio.
      Nei casi in cui questa Applicazione indichi alcuni Dati come facoltativi,
      gli Utenti sono liberi di astenersi dal comunicare tali Dati, senza che
      ciò abbia alcuna conseguenza sulla disponibilità del Servizio o sulla sua
    ...
    <p>
      ...
      pubblicati o condivisi mediante questa Applicazione e garantisce di avere
    ...
    <p>
      ...
      dell’Utente potrebbero essere trasferiti in un paese diverso da quello in
      cui l’Utente si trova. Per ottenere ulteriori informazioni sul luogo del
      trattamento l’Utente può fare riferimento alla sezione relativa ai
    ...
    <hr />
    <div class="title-6">Finalità del Trattamento dei Dati raccolti</div>
    <p>
      ...
      fraudolente, nonché per le seguenti finalità: Gestione della raccolta dati
      e dei sondaggi online e Contattare l'Utente.
    </p>
    <p>
      Per ottenere informazioni dettagliate sulle finalità del trattamento e sui
      Dati Personali trattati per ciascuna finalità, l’Utente può fare
      riferimento alla sezione “Dettagli sul trattamento dei Dati Personali”.
    </p>
    <div class="title-6">Dettagli sul trattamento dei Dati Personali</div>
    <p>
    ...
    <ul>
      <li>
        <b>Contattare l'Utente - Modulo di contatto</b>: L’Utente, compilando
        con i propri Dati il modulo di contatto, acconsente al loro utilizzo per
        rispondere alle richieste di informazioni, di preventivo, o di qualunque
        altra natura indicata dall’intestazione del modulo. Dati Personali
        trattati: cognome; data di nascita; email; nome; numero di telefono;
        varie tipologie di Dati.
      </li>
      <li>
        <b>Gestione della raccolta dati e dei sondaggi online</b>: Questo tipo
        di servizio permette a questa Applicazione di gestire la creazione,
        l'implementazione, l'amministrazione, la distribuzione e l'analisi di
        formulari e di sondaggi online al fine di raccogliere, salvare e
        riutilizzare i Dati degli Utenti che rispondono. I Dati Personali
        raccolti dipendono dalle informazioni richieste e fornite dagli Utenti
        nel formulario online corrispondente. Questi servizi possono essere
        ...
        elaborazione dei pagamenti. Questa Applicazione utilizza formulari per
        raccogliere dati dagli Utenti. Dati Personali trattati: nome; numero di
        telefono.
      </li>
    </ul>
    <div class="title-6">Diritti dell’Utente</div>
    <p>
    ...
    <hr />
    <div class="title-6">Ulteriori informazioni sul trattamento</div>
    ...
    <hr />
    <div class="title-6">Definizioni e riferimenti legali</div>
    ...
    <p>
      ...
      ivi compreso un numero di identificazione personale, renda identificata o
    ...
    <p>
      ...
      richiesta, il metodo utilizzato nell’inoltrare la richiesta al server, la
      dimensione del file ottenuto in risposta, il codice numerico indicante lo
      stato della risposta dal server (buon fine, errore, ecc.) il paese di
      provenienza, le caratteristiche del browser e del sistema operativo
      utilizzati dal visitatore, le varie connotazioni temporali della visita
      (ad esempio il tempo di permanenza su ciascuna pagina) e i dettagli
      relativi all’itinerario seguito all’interno dell’Applicazione, con
      particolare riferimento alla sequenza delle pagine consultate, ai
    ...
    <p>
      ...
      mezzi del trattamento di dati personali e gli strumenti adottati, ivi
    ...
    <p>
      ...
      ordinamenti legislativi, inclusi gli artt. 13 e 14 del Regolamento (UE)
      2016/679.
    </p>
    <p>
    ...
    <hr />
    <p>Ultima modifica: 7 febbraio 2022</p>
  </div>
</ts-layout>
