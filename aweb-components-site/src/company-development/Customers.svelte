<svelte:options tag="ts-company-development-customers" />

<div class="company-development-customers">
  <h3 class="title-3 title-form">Chi ci ha <b>scelto</b></h3>
  <div class="company-development-customers__customers">
    <div class="company-development-customers__customers__customer">
      <ts-picture
        base="customers"
    ...
    <div class="company-development-customers__customers__customer">
      <ts-picture base="customers" src="avio" alt="Avio" />
    </div>
    <div class="company-development-customers__customers__customer">
  ...
  .company-development-customers {
    ...
    &__customers {
      ...
      &__customer {
        ...
        justify-content: center;
        align-items: center;
        margin: 0 variables.$ts-spacing-4 variables.$ts-spacing-6;
